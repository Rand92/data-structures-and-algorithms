...
let arr2=arr.filter(num=> typeof(num) === 'number')
return arr2;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
 let arr5= arr.filter(function(extra){
   return !forbiddenValues.includes(extra);
 })
 return arr5;
};
